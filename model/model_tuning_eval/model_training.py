...
def train_atoi_model(projection_year, retrain_model, verbose):
    ...
    model_path = os.path.join(os.path.dirname(__file__), '..', 'engine_data', 'Projection Models', 'atoi_model.pkl')
...
def train_p24_gp_model(projection_year, retrain_model, verbose):
    ...
    # Define the model path for saving and loading
    model_path = os.path.join(os.path.dirname(__file__), '..', 'engine_data', 'Projection Models', 'p24_gp_model.pkl')
...
def train_u24_gp_model(projection_year, retrain_model, verbose):
    ...
    # Define the model path for saving and loading
    model_path = os.path.join(os.path.dirname(__file__), '..', 'engine_data', 'Projection Models', 'u24_gp_model.joblib')
...
def train_goal_model(projection_year, retrain_model, verbose):
    ...
    if retrain_model == True:
        ...
        # Save the model
        model.save_model(os.path.join(os.path.dirname(__file__), '..', 'engine_data', 'Projection Models', 'goal_model.json'))
        model.save_model(os.path.join(os.path.dirname(__file__), '..', 'engine_data', 'Projection Models', 'goal_model.xgb'))
    
    else:
        model = xgb.Booster()
        model.load_model(os.path.join(os.path.dirname(__file__), '..', 'engine_data', 'Projection Models', 'goal_model.xgb'))
